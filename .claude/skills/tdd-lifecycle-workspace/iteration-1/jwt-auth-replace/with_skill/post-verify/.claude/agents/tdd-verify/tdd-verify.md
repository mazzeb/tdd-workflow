...
### 4. Review Implementation (Green Check)
...
- All tests must pass
- If any test fails, note it as a finding
...
1. Write a `## Feedback` section in the task file (append or replace existing):
   ```markdown
   ## Feedback
   ### Red — YYYY-MM-DD
